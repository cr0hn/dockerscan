...
echo "🚀 Closing DockerScan v1.x issues..."
echo ""
...
close_issue 18 "This issue has been resolved in **DockerScan v2.0** 🎉
...
close_issue 9 "This pip installation issue is resolved in **DockerScan v2.0** 🎉
...
echo "🎉 All issues and PRs have been closed successfully!"
echo ""
echo "Summary:"
